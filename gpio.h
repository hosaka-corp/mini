...
// Default PPC pin ownership
#define GP_OWNER_PPC		(GP_AVE_SDA | GP_AVE_SCL | GP_DOEJECT \
				| GP_SENSORBAR | GP_SLOTIN | GP_SLOTLED)

// Default ARM pin ownership
#define GP_OWNER_ARM		(GP_ALL ^ GP_OWNER_PPC)

#define GP_OUTPUTS		(GP_ALL ^ GP_INPUTS)
#define GP_INPUTS		(GP_POWER | GP_EJECTBTN | GP_SLOTIN \
					| GP_EEP_MISO | GP_AVE_SDA)
